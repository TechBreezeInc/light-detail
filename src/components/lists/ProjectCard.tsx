  ...
  return (
    <div class="w-full h-[600px] flex relative shadow-md">
      <img
        ...
        alt={props.title}
      />
      <div class="flex-1 h-full z-10 overflow-hidden group">
        <p class="w-full h-full bg-black/70 p-6 text-white translate-x-full transition-transform duration-500 group-hover:translate-x-0">
          {props.description}
        </p>
      </div>
